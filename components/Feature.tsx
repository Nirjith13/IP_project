    ...
    <section className="max_padd_container py-20 xl:py-32 bg-white" id="feature">
        <div className="w-[90%] m-auto">
            <div className="mx-4">
                ...
                <p className="max-w-lg">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptatibus ab est unde nesciunt delectus laudantium praesentium eos quae vel provident exercitationem, aut maxime molestias, sint officiis dignissimos velit dicta error?</p>
            </div>
            {/* container */}
            <div className="pt-12">
              <Slider {...settings}>
