  ...
  return (
    <section className="max_padd_container py-16 xl:py-28 bg-slate-10" id="listing">
        <div className="mx-4">
            ...
            <p className="max-w-lg">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam fugiat illo modi nisi commodi animi rerum quos fuga dicta sapiente necessitatibus, corporis adipisci excepturi blanditiis, optio odio reiciendis! Quos, inventore?</p>
        </div>
